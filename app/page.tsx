    ...
    <div className="min-h-screen bg-[#020617] text-white selection:bg-cyan-500/30">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-sm text-cyan-400 backdrop-blur-md mb-8 animate-fade-in">
            <Shield size={16} />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-4">
            <Button size="lg" className="w-full sm:w-auto bg-cyan-600 hover:bg-cyan-500 text-white font-bold h-14 px-8 shadow-[0_0_20px_rgba(8,145,178,0.3)]">
              Deploy National Shield
              <ArrowRight size={18} className="ml-2" />
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/10 hover:bg-white/5 h-14 px-8">
              Technical Architecture
            </Button>
          </div>

          {/* Real-time Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto mt-20 px-4">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                ...
                <div className="text-xs font-bold text-white mt-1 uppercase tracking-widest">{stat.label}</div>
                <div className="text-[10px] text-slate-500 mt-1 italic">{stat.sub}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 border-y border-white/5 bg-slate-900/20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Comparison Table */}
            <div className="bg-slate-900/50 rounded-3xl border border-white/10 p-8 overflow-hidden relative">
              <div className="absolute top-0 right-0 p-4 opacity-10">
                <Shield size={200} />
              </div>
              <h3 className="text-xl font-bold mb-6 flex items-center gap-2 text-cyan-400">
                <CheckCircle2 size={20} /> Competitive Edge Analysis
              </h3>
                  ...
                  {[
                    ...
                    <tr key={i} className="group">
                      ...
                      <td className="py-4 text-center">
                        <CheckCircle2 size={16} className="mx-auto text-green-400" />
                      </td>
                      <td className="py-4 text-right">
                        {global ? (
                          <CheckCircle2 size={16} className="ml-auto text-slate-600" />
                        ) : (
      ...
      <section id="architecture" className="py-24 px-4 bg-[#020617]">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4">THE TITAN STACK</h2>
            <p className="text-slate-400">Total protection across every digital layer</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-[2rem] bg-white/5 border border-white/10 hover:border-cyan-500/40 transition-all group">
